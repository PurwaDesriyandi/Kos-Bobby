...
<script>
    function submit() {
        ...
        const formData = { date, kritiksaran };
    ...
    function loadFormData() {
        ...
        data.forEach(item => addToTable(item));
    }
    ...
    function addToTable(formData) {
        ...
        const kritiksaranCell = row.insertCell(1);

        dateCell.textContent = formData.date;
        kritiksaranCell.textContent = formData.kritiksaran;
    }
