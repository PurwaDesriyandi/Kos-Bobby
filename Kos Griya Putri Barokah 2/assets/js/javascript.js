...
function total() {
    ...
    if (rentDuration) {
        total += parseFloat(rentDuration.value); // Add the rent duration value
    }
    
    facilities.forEach(function(facility) {
        total += parseFloat(facility.id) * parseFloat(rentDuration.value); // Multiply facility ID with rent duration value
    });
